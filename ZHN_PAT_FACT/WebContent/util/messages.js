jQuery.sap.declare("com.ril.hn.emrpatient.util.messages");
jQuery.sap.require("sap.ca.ui.message.message");

com.ril.hn.emrpatient.util.messages = {};
 ...
 * @public
 */
com.ril.hn.emrpatient.util.messages.showErrorMessage = function(oParameter) {
	var oErrorDetails = com.ril.hn.emrpatient.util.messages._parseError(oParameter);
...
com.ril.hn.emrpatient.util.messages.getErrorContent = function(oParameter) {
	return com.ril.hn.emrpatient.util.messages._parseError(oParameter).sMessage;
};

com.ril.hn.emrpatient.util.messages._parseError = function(oParameter) {
	var sMessage = "",
		sDetails = "",
		oEvent = null,
		oResponse = null,
